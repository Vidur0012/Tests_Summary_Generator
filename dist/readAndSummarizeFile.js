...
exports.readAndSummarizeFile = void 0;
...
const readAndSummarizeFile = (filePath, projectName, suiteName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = {
            project: projectName,
            suite: suiteName,
        ...
        const worksheet = workbook.Sheets[namingconfig_json_1.sanity.sheetName];
        if (!worksheet) {
...
exports.readAndSummarizeFile = readAndSummarizeFile;
